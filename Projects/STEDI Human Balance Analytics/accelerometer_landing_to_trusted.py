...
'''
SharewithResearch_node1741128296521 = sparkSqlQuery(glueContext, query = SqlQuery2876, mapping = {"customerTrusted":CustomerTrusted_node1741128144564, "accelerometerLanding":AccelerometerLanding_node1741127900211}, transformation_ctx = "SharewithResearch_node1741128296521")
...
AmazonS3_node1741128824094 = glueContext.getSink(path="s3://sunnybucket-v2/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1741128824094")
AmazonS3_node1741128824094.setCatalogInfo(catalogDatabase="stedi",catalogTableName="accelerometer_trusted")
